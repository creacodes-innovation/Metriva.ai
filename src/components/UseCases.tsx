const cases = [
  {
    tag: "Defense & cadets",
    title: "12,000 cadets, 3 days, zero spreadsheets",
    metric: "98.6%",
    label: "first-pass accuracy",
  },
  {
    tag: "Corporate uniforms",
    title: "Onboard a 5,000-person workforce in a week",
    metric: "4.2 days",
    label: "roster to delivery",
  },
  {
    tag: "School uniforms",
    title: "Annual fittings without pulling kids from class",
    metric: "32s",
    label: "average per student",
  },
  {
    tag: "Bespoke tailoring",
    title: "Remote measurements for distributed clients",
    metric: "0",
    label: "in-store visits required",
  },
];
