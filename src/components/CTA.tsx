    ...
    <section id="cta" className="py-28 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 relative">
        <div className="relative rounded-3xl border border-royal/30 bg-card p-12 sm:p-16 text-center overflow-hidden shadow-royal animate-fade-up">
          <div
            className="absolute -top-32 left-1/2 -translate-x-1/2 w-96 h-96 rounded-full bg-royal/20 blur-3xl"
            aria-hidden
          />
          <div
            className="absolute -bottom-32 right-0 w-96 h-96 rounded-full bg-cyan-glow/20 blur-3xl"
            aria-hidden
          />
          ...
          <div className="relative">
            <p className="font-mono text-xs uppercase tracking-[0.2em] text-royal mb-6">
              — Pilot programme
            </p>
            ...
            <p className="mt-6 text-muted-foreground max-w-xl mx-auto">
              We'll set up your project, train two operators, and validate accuracy against your
              tape measurements — at no cost.
            </p>
