        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16 animate-fade-up">
          <div className="max-w-2xl">
            ...
            <h2 className="font-display text-4xl sm:text-5xl font-bold leading-tight text-balance">
              Built for the field. <br /> Engineered for the{" "}
              <span className="brand-text">cutting table</span>.
            </h2>
          </div>
          <p className="text-muted-foreground max-w-sm">
            Six measurements, six guarantees. Every feature exists to remove a step between the
            subject and the cutting table.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-border rounded-2xl overflow-hidden border border-border">
          {features.map((f, i) => (
            ...
            >
              ...
              <h3 className="font-display text-xl font-semibold mb-3 group-hover:text-royal transition-colors">
                {f.title}
              </h3>
